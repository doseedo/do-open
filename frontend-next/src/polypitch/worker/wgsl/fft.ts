...
fn main(
  ...
  // Gate the read/write work on \`in_bounds\` but let all threads reach each
  // barrier. (\`active\` also fits semantically but it's a WGSL reserved
  // keyword — using it renders the shader uncompilable.)
