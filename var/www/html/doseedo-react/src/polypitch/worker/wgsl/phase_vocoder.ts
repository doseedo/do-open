// Auto-generated from phase_vocoder.wgsl — keep in sync if the .wgsl is edited.
const source = `// Classical Laroche-Dolson phase-vocoder pitch shifter (bin-wise variant).
//
