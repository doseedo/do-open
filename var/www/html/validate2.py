...
INPUT_JSON = Path("final_training_manifest_final.json")
ERROR_LOG  = Path("validation_errors.txt")
VALID_CSV  = Path("validation_valid_specs.csv")   # NEW: specs for valid entries
...
ENC_REL_FRACTION = 0.015  # 1% of expected
...
def main():
    ...
    for entry in data:
        ...
        # Extract the tensor from latent (handle both dict and tensor cases)
