...
const jobs = [
  { html: 'vision-helixref.html',  out: 'vision-helixref.png',  viewport: { width: 720, height: 900 } },
  { html: 'vision-strataref.html', out: 'vision-strataref.png', viewport: { width: 620, height: 900 } },
];
