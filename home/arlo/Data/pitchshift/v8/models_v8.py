...
class RegisterTranslator(nn.Module):
    ...
    V8: residual_scale increased to 0.3 (was 0.1 in V2)
    """
    ...
    def __init__(
        ...
        # V8: Increased residual_scale from 0.1 to 0.3 for stronger transformation
        self.register_buffer('dry_scale', torch.tensor(1.0))
        self.register_buffer('residual_scale', torch.tensor(0.3))  # V8: was 0.1
...
if __name__ == "__main__":
    print("Testing RegisterTranslator (V8)...")
    ...
    print(f"  residual_scale: {model.residual_scale.item()}")

    print("\nTesting RegisterTranslatorDirect (V8)...")
