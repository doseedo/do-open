"""
Register-Aware Pitch Shift Dataset V8
...
class RegisterTransferDatasetV8(Dataset):
    """
    Dataset for V8 register timbre conversion using DISTRIBUTION MATCHING.
...
if __name__ == "__main__":
    # Test dataset
    dataset = RegisterTransferDatasetV8(
